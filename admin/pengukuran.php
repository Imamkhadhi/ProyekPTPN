...
<body>
    ...
    <script>
        ...
        drawGauge('gauge1', 'https://api-jurnal-ptpn.teluapp.org/api/uap-masuk', 40, uapMasukRanges, uapMasukLabels);
        fetch('https://api-jurnal-ptpn.teluapp.org/api/uap-masuk')
